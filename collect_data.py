...
def collect(login):
    ...
    result['repos']=[{k:r.get(k) for k in ['name','full_name','html_url','description','stargazers_count','forks_count','language','archived','pushed_at','license','topics','created_at','homepage']} for r in eligible]
...
if __name__=='__main__':
    ...
    payload=json.dumps({'fetched_at':datetime.datetime.now(datetime.timezone.utc).isoformat(),'developers':results,'errors':errors})
